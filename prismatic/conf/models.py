...
@dataclass
class Prism_Qwen25_0_5B_Extra_DINOSigLIP_224px_FusedFAN(Prism_Qwen25_0_5B_DINOSigLIP_224px):
    model_id: str = "prism-qwen25-extra-dinosiglip-224px+0_5b+fusedfan-projector"
...
class ModelRegistry(Enum):
    ...
    PRISM_QWEN25_EXTRA_DINOSIGLIP_224PX_0_5B_FusedFAN = Prism_Qwen25_0_5B_Extra_DINOSigLIP_224px_FusedFAN
